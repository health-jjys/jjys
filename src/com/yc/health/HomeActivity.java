...
public class HomeActivity extends KJActivity implements OnGestureListener{
	...
	public static final String MESSAGE_RECEIVED_ACTION = "com.yc.health.MESSAGE_RECEIVED_ACTION";
	...
	public class MessageReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			if (MESSAGE_RECEIVED_ACTION.equals(intent.getAction())) {
              ...
              Logutil.ShowToast(HomeActivity.this, showMsg.toString(), true);
              Logutil.Log(showMsg.toString());
